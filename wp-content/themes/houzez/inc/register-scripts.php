    ...
    function houzez_enqueue_styles() {
        ...
        if ( ! is_admin() ) {
            ...
            if( houzez_option('css_all_in_one', 1) ) {
                ...
                wp_enqueue_style('bootstrap-select', HOUZEZ_CSS_DIR_URI . 'bootstrap-select.min.css', array(), '1.13.9');
                wp_enqueue_style('font-awesome', HOUZEZ_CSS_DIR_URI . 'font-awesome.min.css', array(), '4.7.0');
    ...
    function houzez_enqueue_scripts() {
        if ( ! is_admin() ) {
            ...
            if( houzez_option('js_all_in_one', 1) ) {
                ...
                wp_enqueue_script('bootstrap-select', HOUZEZ_JS_DIR_URI. 'vendors/bootstrap-select.min.js', array('jquery'), '1.13.9', true);
            ...
            array(
                ...
                'search_min_price_range' => houzez_option('advanced_search_widget_min_price', 0),
                'search_max_price_range' => houzez_option('advanced_search_widget_max_price', 2500000),
        ...
        if(houzez_is_dashboard()) {    
            ...
            wp_enqueue_script('houzez_property', HOUZEZ_JS_DIR_URI . 'houzez_property.js', array('jquery', 'plupload', 'jquery-ui-sortable'), HOUZEZ_THEME_VERSION, true);
            $prop_data = array(
            ...
            if (is_page_template('template/user_dashboard_profile.php') || is_page_template('template/user_dashboard_gdpr.php') || is_page_template('template/user_dashboard_membership.php')) {
                ...
                wp_register_script('houzez_user_profile', HOUZEZ_JS_DIR_URI . 'houzez_user_profile.js', array('jquery', 'plupload'), HOUZEZ_THEME_VERSION, true);
