            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="agent-profile-top-wrap">
						...
						<p class="agent-list-position"> <?php echo esc_attr( $current_author_meta['fave_author_title'][0] ); ?>
							<?php if(!empty($current_author_meta['fave_author_company'][0])) { ?>
                    ...
                    <div class="agent-profile-content">
                        <ul class="list-unstyled">
                            ...
                            <?php 
                            if( !empty($current_author_meta['fave_author_license'][0]) ) { ?>
								<li>
							...
							<?php 
                            if( !empty($current_author_meta['fave_author_tax_no'][0]) ) { ?>
								<li>
							...
							<?php 
                            if( !empty($current_author_meta['fave_author_service_areas'][0]) ) { ?>
								<li>
							...
							<?php 
                            if( !empty($current_author_meta['fave_author_specialties'][0]) ) { ?>
								<li>
        ...
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <div class="agent-bio-wrap">
                    ...
                    <?php 
                    if( !empty( $current_author_meta['fave_author_language'][0] ) ) { ?>
						<p>
                ...
                <aside class="sidebar-wrap">
                    ...
                    <div class="agent-contacts-wrap">
                        ...
                        <div class="agent-map">
                            ...
                            if( !empty($current_author_meta['fave_author_address'][0])) {
