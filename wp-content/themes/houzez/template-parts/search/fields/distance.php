...
<div class="form-group">
	<select name="<?php echo esc_attr($field_name); ?>" data-size="8" class="selectpicker form-control bs-select-hidden" title="<?php echo houzez_option('srh_radius', 'Radius');?>" data-live-search="true">
