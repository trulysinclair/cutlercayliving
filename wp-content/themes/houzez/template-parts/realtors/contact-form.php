            ...
            <div class="modal-body">
                <div class="property-form-wrap">
                    ...
                    <div class="property-form-terms">
                        <?php esc_html_e('By submitting this form I agree to','houzez'); ?> <a target="_blank" href="<?php echo esc_url(get_permalink($terms_page_id)); ?>"><?php esc_html_e('Terms of Use','houzez'); ?></a>
