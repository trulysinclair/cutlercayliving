...
<div class="form-tools">
    <label class="control control--checkbox">
        ...
        <?php echo sprintf( wp_kses(__( 'I agree with your <a target="_blank" href="%s">Terms & Conditions</a>', 'houzez' ), $allowed_html_array), get_permalink(houzez_option('login_terms_condition')) ); ?>
