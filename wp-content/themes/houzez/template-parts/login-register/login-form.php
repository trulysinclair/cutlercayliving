...
<div class="social-login-wrap">
    ...
    <button type="button" class="hz-facebook-login btn btn-facebook-lined btn-full-width">
        <?php get_template_part('template-parts/loader'); ?>
        <i class="houzez-icon icon-social-media-facebook mr-1"></i> <?php esc_html_e( 'Login with Facebook', 'houzez' ); ?>
    </button>
    <?php } ?>
    ...
    <button type="button" class="hz-google-login btn btn-google-plus-lined btn-full-width">
        <?php get_template_part('template-parts/loader'); ?>
        <i class="houzez-icon icon-social-media-google-plus-1 mr-1"></i> <?php esc_html_e( 'Login with Google', 'houzez' ); ?>
    </button>
    <?php } ?>
