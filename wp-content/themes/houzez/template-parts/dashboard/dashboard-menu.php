...
$crm_leads = add_query_arg( 'page', 'leads', $dashboard_crm );
$crm_deals = add_query_arg( 'page', 'deals', $dashboard_crm );
$crm_enquiries = add_query_arg( 'page', 'enquiries', $dashboard_crm );
$crm_activities = add_query_arg( 'page', 'activities', $dashboard_crm );
