<table class="dashboard-table additional-details-table">
	...
	<tbody id="houzez_additional_details_main">
		...
		<tr>
			<td class="table-half-width">
				<input class="form-control" name="additional_features[0][fave_additional_feature_title]" placeholder="<?php esc_html_e( 'Eg: Equipment', 'houzez' ); ?>" type="text">
			</td>
			<td class="table-half-width">
				<input class="form-control" name="additional_features[0][fave_additional_feature_value]" placeholder="<?php esc_html_e( 'Grill - Gas', 'houzez' ); ?>" type="text">
			</td>
			<td class="">
				<a class="sort-additional-row btn btn-light-grey-outlined"><i class="houzez-icon icon-navigation-menu"></i></a>
			</td>
