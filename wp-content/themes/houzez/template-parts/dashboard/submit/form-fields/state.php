...
<div class="form-group">
	...
	if(houzez_option('location_dropdowns') == 'yes') { ?>
		<select name="administrative_area_level_1" data-state="<?php echo esc_attr($state); ?>" data-target="houzezThirdList" <?php houzez_required_field_2('state'); ?> id="countyState" class="houzezSelectFilter houzezSecondList selectpicker form-control bs-select-hidden" data-size="5" data-live-search="true">
            <?php
	        if (houzez_edit_property()) {
	            global $property_data;
