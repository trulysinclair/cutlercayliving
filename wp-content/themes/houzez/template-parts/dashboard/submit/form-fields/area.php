...
<div class="form-group">
	...
	if(houzez_option('location_dropdowns') == 'yes') { ?>
		<select name="neighborhood" data-area="<?php echo esc_attr($area); ?>" data-size="5" id="neighborhood" <?php houzez_required_field_2('area'); ?> class=" houzezSelectFilter houzezFourthList selectpicker form-control bs-select-hidden" data-live-search="true">
            <?php
	        if (houzez_edit_property()) {
	            global $property_data;
