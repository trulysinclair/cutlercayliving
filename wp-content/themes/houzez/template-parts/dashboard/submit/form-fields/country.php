...
<div class="form-group">
	...
	if(houzez_option('location_dropdowns') == 'yes') { ?>
		<select name="country" id="country" data-country="<?php echo esc_attr($country); ?>" data-target="houzezSecondList" <?php houzez_required_field_2('country'); ?> class="houzezSelectFilter houzezFirstList selectpicker form-control bs-select-hidden" data-size="5" data-live-search="true">
            <?php
	        if (houzez_edit_property()) {
