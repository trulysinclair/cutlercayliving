...
<div class="form-group">
	...
	if(houzez_option('location_dropdowns') == 'yes') { ?>
		<select name="locality" id="city" data-city="<?php echo esc_attr($city); ?>" data-target="houzezFourthList" <?php houzez_required_field_2('city'); ?> class="houzezSelectFilter houzezThirdList selectpicker form-control bs-select-hidden"  data-size="5" data-live-search="true">
            <?php
	        if (houzez_edit_property()) {
	            global $property_data;
