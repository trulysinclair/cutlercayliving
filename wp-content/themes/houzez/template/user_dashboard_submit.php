            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dashboard-header-right">
                    <button id="save_as_draft" class="btn btn-primary-outlined fave-load-more">
                        ...
                        <?php esc_html_e('Save as Draft', 'houzez'); ?>        
                    </button>
...
if(houzez_get_map_system() == 'google') {
    if(houzez_option('googlemap_api_key') != "") {
        wp_enqueue_script('houzez-submit-google-map', HOUZEZ_JS_DIR_URI . 'submit-property-google-map.js', array('jquery'), HOUZEZ_THEME_VERSION, true);
    }
    
} else {
    wp_enqueue_script('houzez-submit-osm', HOUZEZ_JS_DIR_URI . 'submit-property-osm.js', array('jquery'), HOUZEZ_THEME_VERSION, true);
}
?>
