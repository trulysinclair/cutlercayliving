				...
				<div class="row">
					...
					<div class="col-sm-12 col-xs-12">
						<div class="form-group form-group-textarea">
							...
							<textarea class="form-control" name="message" rows="5" placeholder="<?php echo houzez_option('spl_con_message_plac', 'Message'); ?>"><?php echo houzez_option('spl_con_interested', "Hello, I am interested in"); ?> [<?php echo get_the_title(); ?>]</textarea>
						</div>
