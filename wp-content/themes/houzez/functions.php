...
define( 'HOUZEZ_THEME_VERSION', '2.1.0' );
...
if( houzez_theme_verified() ) {
	require_once( HOUZEZ_FRAMEWORK . 'metaboxes/houzez-meta-boxes.php' );
...
if ( class_exists( 'ReduxFramework' ) ) {
	require_once( HOUZEZ_FRAMEWORK . 'options/houzez-options.php' );
	require_once( HOUZEZ_FRAMEWORK . 'options/main.php' );
}
