...
if(!function_exists('houzez_enqueue_geo_location_js')) {
    function houzez_enqueue_geo_location_js() {
        ...
        if( !wp_script_is('google-map-properties') ) {
            $map_options = array();
            wp_register_script( 'google-map-properties', HOUZEZ_JS_DIR_URI . 'google-map-properties' . houzez_minify_js() . '.js', array( 'jquery', 'houzez-google-map-api' ), HOUZEZ_THEME_VERSION, true );
...
if( !function_exists( 'houzez_get_single_property_map' ) ) {
    ...
    function houzez_get_single_property_map() {
        ...
        wp_register_script( 'houzez-single-property-map', HOUZEZ_JS_DIR_URI . 'single-property-google-map' . houzez_minify_js() . '.js', array( 'jquery', 'houzez-google-map-api' ), HOUZEZ_THEME_VERSION, true );
