...
if( !function_exists('houzez_ajax_update_profile') ):
    ...
    function houzez_ajax_update_profile(){
        ...
        $user_company = $userlangs = $latitude = $longitude = $tax_number = $user_location = $license = $user_address = $fax_number = $firstname = $lastname = $title = $about = $userphone = $usermobile = $userskype = $facebook = $twitter = $linkedin = $instagram = $pinterest = $profile_pic = $profile_pic_id = $website = $useremail = $service_areas = $specialties = '';
        ...
        if ( !empty( $_POST['about'] ) ) {
            $about = wp_kses_post(  wptexturize( $_POST['about'] )  );
