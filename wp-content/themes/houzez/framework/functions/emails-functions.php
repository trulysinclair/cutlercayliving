...
if( !function_exists( 'houzez_ele_inquiry_form' ) ) {
    function houzez_ele_inquiry_form() {
        ...
        $crm_enquiries = add_query_arg( 'page', 'enquiries', $dashboard_crm );
...
if( !function_exists('houzez_property_agent_contact') ) {
    function houzez_property_agent_contact() {
        ...
        if (! empty($property_id)) {
            $body .= esc_html__("Property ID : ", 'houzez') . $property_id . " <br/>";
        }
        ...
        if (! empty($user_type)) {
            $body .= esc_html__("User Type : ", 'houzez') . $user_type . " <br/>";
        }

        $body .= "<br/>" . esc_html__("Additional message is.", 'houzez') . " <br/>";
        $body .= wp_kses_post( wpautop( wptexturize( $sender_msg ) ) ) . " <br/>";
        ...
        $headers[] = "Reply-To: $sender_name <$sender_email>";
        $headers[] = "Content-Type: text/html; charset=UTF-8";
        $headers = apply_filters( "houzez_property_agent_mail_header", $headers );// Filter for modify the header in child theme
...
if( !function_exists('houzez_schedule_send_message') ) {
    function houzez_schedule_send_message() {
        ...
        $headers[] = "Reply-To: $sender_name <$sender_email>";
        $headers[] = "Content-Type: text/html; charset=UTF-8";
        $headers = apply_filters( "houzez_schedule_tour_mail_header", $headers );// Filter for modify the header in child theme
