...
class Houzez_Elementor_Inquiry_Form extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $field_types = [
            ...
            'e_meta[price]' => esc_html__( 'Price', 'houzez-theme-functionality' ), //number
            'e_meta[beds]' => esc_html__( 'Bedrooms', 'houzez-theme-functionality' ), //number
            'e_meta[baths]' => esc_html__( 'Bathrooms', 'houzez-theme-functionality' ), //number
            'e_meta[area-size]' => esc_html__( 'Area Size', 'houzez-theme-functionality' ), //number
    ...
    protected function render() {
        ...
        <script>
            ...
            jQuery(document).ready(function() {
                jQuery('#houzez-form-<?php echo $this->get_id(); ?>').on('submit', function(e) {
                    e.preventDefault();
        ...
        <form class="elementor-form" id="houzez-form-<?php echo $this->get_id(); ?>" method="post" <?php echo $this->get_render_attribute_string( 'form' ); ?>>
                        ...
                        <div class="gdpr-agreement-subgroup">
                            <span class="gdpr-field-option">
                                <label class="gdpr-text" for="gdpr_agreement">
                                    <input <?php if($settings['gdpr_required']){ echo 'required'; } ?> type="checkbox" name="gdpr_agreement" id="gdpr_agreement">  <?php echo wp_kses($settings['gdpr_text'], $allowed_html); ?>
                                </label>
                            </span>
                        </div>             
                    </div>
