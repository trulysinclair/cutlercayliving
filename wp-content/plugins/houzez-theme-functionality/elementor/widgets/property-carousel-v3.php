...
class Houzez_Elementor_Properties_Carousels_v3 extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'slides_meta_position',
            [
                'label'     => esc_html__( 'Meta Position', 'houzez-theme-functionality' ),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'caption-above'  => esc_html__( 'Above Image', 'houzez-theme-functionality'),
                    'caption-bottom'    => esc_html__('Bottom ( Recommended for more then 3 columns )', 'houzez-theme-functionality')
                ],
                "description" => esc_html__("You can make a post featured by clicking featured properties checkbox while add/edit post", "houzez-theme-functionality"),
                'default' => 'caption-above',
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Houzez_Elementor_Properties_Carousels_v3 );