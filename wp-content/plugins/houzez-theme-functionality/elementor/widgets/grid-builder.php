...
class Houzez_Elementor_Grid_Builder extends Widget_Base {
    ...
    protected function render() {
        ...
        <div class="grid-item <?php houzez_lazyload_for_bg(); ?> <?php echo esc_attr($settings['grid_type']); ?>" style="background-image: url(<?php echo esc_url($image); ?>)">
